...
const data = [
  "Hello! I’m Jaka , a full-stack developer from Slovenia with a keen interest in both web2 and web3 technologies. Currently pursuing a master’s in business informatics at the School of Economics and Business Ljubljana, I combine solid business knowledge with technical expertise to create impactful digital solutions. <br> Over the past 2.5 years, I have immersed myself in the development world, gaining hands-on experience and a deep understanding of various programming languages and frameworks. My educational journey is complemented by professional certifications, including a prestigious Full Stack Developer Career Path. This certification, among others, stands testament to my dedication and capability in tackling diverse and complex technical challenges. <br> In the realm of development, I thrive on learning and employing cutting-edge technologies. My portfolio spans dynamic e-commerce platforms to sophisticated decentralized applications, showcasing my ability to handle complex technical tasks. My enthusiasm for the latest tech innovations keeps me continuously evolving and at the forefront of the industry. <br> Outside of coding, I am an avid sports enthusiast and fitness buff, particularly passionate about basketball. This energy extends into my personal pursuits where I enjoy exploring the world and discovering new things. Whether it’s staying updated with the latest tech innovations or delving into books on personal growth, I am always learning. <br> I am known for my devotion and reliability, consistently standing firm in my commitments. I thrive on setting myself challenges and overcoming them, which aligns with my professional work where I am dedicated to delivering projects with precision and passion. <br> I am also a social individual who loves connecting with people from diverse backgrounds. Every interaction is an opportunity to learn and grow together, which is why I value my time collaborating with others, whether in hackathons or team projects. <br> Feel free to connect with me or explore my work further through my site. Let’s collaborate to create something exceptional!",
];
